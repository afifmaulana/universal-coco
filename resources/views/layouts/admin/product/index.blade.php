            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <div class="card-title">Our Product List</div>
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ asset('uploads/products/' . $data->image) }}" data-toggle="lightbox">
                                            <img src="{{ asset('uploads/products/' . $data->image) }}" height="70"
                                                width="70">
                                        </a>
                                    </td>
                                    <td>
...
@push('scripts')
    <script>
        $(document).on('click', '.modal-delete', function() {
            ...
            $('#deleteButton').attr("href", '{{ route('product.delete', '') }}' + "/" + id)
        });
    </script>
@endpush
