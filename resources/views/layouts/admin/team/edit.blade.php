					...
					<div class="d-flex justify-content-center">
						<div class="col-md-8">
							<div class="form-group">
								...
								<input type="text" class="form-control {{$errors->has('name')?'is-invalid':''}}" name="name" id="input-name" value="{{ $data->name }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
								...
								<input type="text" class="form-control {{$errors->has('position')?'is-invalid':''}}" name="position" id="input-position" value="{{ $data->position }}">
							...
							<div class="form-group">
								...
								<textarea id="summernote" class="form-control {{$errors->has('caption')?'is-invalid':''}}" name="caption" id="input-deskirpsi">{{ $data->caption }}</textarea>
							...
							<div class="form-group">
                                ...
                                @endif
                                <img src="{{asset('uploads/teams/'.$data->image)}}" class="img-fluid mb-2">
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Linked In</label>
                                        <input type="text" class="form-control {{$errors->has('linkedin')?'is-invalid':''}}" name="linkedin" id="input-linkedin" value="{{ $data->linkedin }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{$errors->has('instagram')?'is-invalid':''}}" name="instagram" id="input-instagram" value="{{ $data->instagram }}">
