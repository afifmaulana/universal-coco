...
<body>
    ...
    <section class="" style="background-color: #f6f7f6;">
                    ...
                    <div class="carousel-item active">
                        <div class="row">
                            <div class="col-sm-12 col-md-6 p-5">
                                <div class="px-md-5" data-aos="fade">
                                    ...
                                    <p class="text-16 text-md-xl lead" style="line-height: 160%;">
                                        Virgin coconut oil is the oil extracted from coconuts without the application of
                                        heat.
                                        It is rapidly gaining popularity throughout the world in comparison to ordinary
                                        coconut oil and for a good reason. There is, in fact, a substance called virgin
                                        coconut oil and it differs from regular coconut oil in significant ways.
                                        These differences mainly lie with the source (more specifically, the physical
                                        form of the
                                        source),
                            ...
                            <div class="col-sm-12 col-md-6 p-5">
                                <div class="px-md-5" data-aos="fade">
                                    <div>
                                        <img src="{{ asset('assets/images/coconut1.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 p-5">
                                <div class="px-md-5" data-aos="fade">
                                    <div>
                                        <img src="{{ asset('assets/images/coconut-peat-blocks.777f5293.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center mb-4">
                    <div class="col-md-7 text-center">
                        <h3 class="mb-3 text-30 fw-bold">Our Teams</h3>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                <div class="pt-2">
                                    <h5 class="mt-4 font-weight-medium mb-0 text--green">Julio</h5>
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                <div class="pt-2">
                                    <h5 class="mt-4 font-weight-medium mb-0">Alhafis Wijaya</h5>
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                <div class="pt-2">
                                    <h5 class="mt-4 font-weight-medium mb-0">Stella Carissa</h5>
