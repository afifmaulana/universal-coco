                ...
                <div class="col-lg-6 px-md-5">
                    <div class="card1 pb-5 px-md-5">
                        <div class="row px-5 text-center mt-4 mb-5">
                            <h2 style="color: #1150a1; font-weight: 800">Selamat Datang Admin</h2>
                            <div class="row px-3 justify-content-center mt-4 mb-5">
                                <svg id="a5c16198-98a1-478b-8909-43624583dcf2" data-name="Layer 1"
                                    ...
                                    <ellipse cx="158" cy="539.73152" rx="158" ry="12" fill="#1150a1" />
                                    <path
                                        ...
                                        transform="translate(-203.5 -174.13424)" fill="#1150a1" />
                                    <path
                                    ...
                                    <polygon
                                        ...
                                        fill="#2f2e41" />
                                    <circle cx="707.33457" cy="77.37523" r="77.37523" fill="#1150a1" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-203.5 -174.13424)" fill="#1150a1" />
                                    <circle cx="384.19021" cy="198.69546" r="24.03645" fill="#1150a1" />
                                    <path
                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5" style="box-shadow: none">
                        <div class="row mb-4 px-3">
                            <h4 class="mb-0 mr-4 mt-2 text-center">Silahkan Login</h4>
                        </div>
                        ...
                        <form action="{{ route('admin.login.submit') }}" method="POST">
                            ...
                            <div class="row px-3">
                                ...
                                <input class="form-control mb-4 {{ $errors->has('email') ? ' is-invalid' : '' }}"
